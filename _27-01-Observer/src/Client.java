public class Client {
    public static void main(String[] args) {
        ...
        // register observers to the subject, could have added
        // the registration as part of observer constructor (passing in the subject
        topic.register(obj1);
        topic.register(obj2);
        topic.register(obj3);
        ...
        topic.postMessages("New Message");
    }
}
